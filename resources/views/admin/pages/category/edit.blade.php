...
@section('actions')
    <div class="d-flex align-items-center py-3 py-md-1">
        <a href="{{ route('admin.categories.index') }}" class="btn btn-custom btn-active-white btn-active-color-primary">
            Back To List
        </a>
    </div>
@stop
...
@section('content')
    <form id="kt_modal_add_category_form" enctype="multipart/form-data" class="form" method="post"
                                    ...
                                    <div class="tab-pane fade active show" id="kt_tab_pane_1" role="tabpanel">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="en[name]"
                                                   ...
                                                   placeholder="Category Name" value="{{ old('en.name',$category->translate('en')->name) }}"/>
                                            @error('en.name')
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea class="form-control form-control-solid mb-3 mb-lg-0" name="en[description]" id="description" cols="30" rows="10">
                                                {{ old('en.description',$category->translate('en')->description) }}
                                            </textarea>
                                    ...
                                    <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="de[name]"
                                                   class="form-control form-control-solid mb-3 mb-lg-0"
                                                   placeholder="{{ __('Category Name') }}" value="{{ old('de.name',$category->translate('de')->name) }}"/>
                                            @error('de.name')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea class="form-control form-control-solid mb-3 mb-lg-0" name="de[description]" id="description" cols="30" rows="10">
                                                {{old('de.description',$category->translate('de')->description)}}
                                            </textarea>
