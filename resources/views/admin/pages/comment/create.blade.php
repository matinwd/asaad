                            ...
                            <div class="row">
                                <div class="mb-10">
                                    ...
                                    <div class="nav-group nav-group-fluid">
                                        <label>
                                            <input onchange="checkCommentInput()" checked type="radio" name="comment_section" value="main" class="btn-check">
                                            <span class="btn btn-lg btn-color-muted btn-active btn-active-primary">Main Comment Section</span>
                                        </label>
                                        <label>
                                            <input  onchange="checkCommentInput()" type="radio" name="comment_section" value="post" class="btn-check">
