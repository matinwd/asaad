                                    ...
                                    <div class="tab-pane fade active show" id="kt_tab_pane_1" role="tabpanel">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="en[name]"
                                                   ...
                                                   placeholder="Post Name" value="{{ old('en.name') }}"/>
                                            @error('en.name')
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="en[tags]"
                                                   class="form-control form-control-solid mb-3 mb-lg-0"
                                                   placeholder="{{ __('Tags (Separate each tag with (,)) ') }}" value="{{ old('en.tags') }}"/>
                                            @error('en.tags')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="de[name]"
                                                   class="form-control form-control-solid mb-3 mb-lg-0"
                                                   placeholder="{{ __('Post Name') }}" value="{{ old('de.name') }}"/>
                                            @error('de.name')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="de[tags]"
                                                   class="form-control form-control-solid mb-3 mb-lg-0"
                                                   placeholder="{{ __('Tags (Separate each tag with (,))') }}" value="{{ old('de.tags') }}"/>
                                            @error('de.tags')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
