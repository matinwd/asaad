                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px" style="max-height: 222px;">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-12 fv-row fv-plugins-icon-container">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" value="{{ old('discount',$product->discount) }}" class="form-control form-control-solid" placeholder="17.00" name="discount">
                                    @error('discount')
                                ...
                                <div class="row">
                                    <div class="mb-10">
                                        ...
                                        <div class="nav-group nav-group-fluid">
                                            <label>
                                                <input {{ $product->discount_type == 'fixed' ? 'checked' : '' }} type="radio" name="discount_type" value="fixed" class="btn-check">
                                                <span class="btn btn-sm btn-color-muted btn-active btn-active-primary">Fixed</span>
                                            </label>

                                            <label>
                                                <input  {{ $product->discount_type == 'percent' ? 'checked' : '' }}  type="radio" name="discount_type" value="percent" class="btn-check">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 fv-row fv-plugins-icon-container">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" value="{{ old('discount',$product->special_price) }}" class="form-control form-control-solid" placeholder="" name="special_price">
                                    @error('special_price')
                                    <div class="invalid-feedback d-block">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="row">
                                    <div class="mb-10">
                                        ...
                                        <div class="nav-group nav-group-fluid">
                                            <label>
                                                <input {{ $product->special_price_type == 'fixed' ? 'checked' : '' }} type="radio" name="special_price_type" value="fixed" class="btn-check">
                                                <span class="btn btn-sm btn-color-muted btn-active btn-active-primary">Fixed</span>
                                            </label>

                                            <label>
                                                <input type="radio" {{ $product->special_price_type == 'percent' ? 'checked' : '' }}  name="special_price_type" value="percent" class="btn-check">
                                                <span class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Percent</span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="row">
                                    <div class="d-flex flex-column mb-8 col-md-6">
                                        ...
                                        <input  type="date" name="special_price_start" value="{{ $product->special_price_start }}" class="form-control form-control-solid">
                                    </div>
                                    <div class="d-flex flex-column mb-8 col-md-6">
                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                            <span class="">Special Price End Date</span>
                                        </label>
                                        <input type="date" name="special_price_end" value="{{ $product->special_price_end }}" class="form-control form-control-solid">
                                    </div>
                                </div>
                                <!--end::Col-->
                            </div>
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7">
                                    ...
                                    <div class="tab-pane fade active show" id="kt_tab_pane_1" role="tabpanel">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="en[name]"
                                                   value="{{ old('name',$product->translate('en')->name) }}"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea class="form-control form-control-solid mb-3 mb-lg-0" name="en[description]" id="description" cols="30" rows="10">
                                                {{ old('en.description',$product->translate('en')->description ) }}
                                            </textarea>
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea class="form-control form-control-solid mb-3 mb-lg-0" name="en[return_policy]" id="return_policy" cols="30" rows="10">
                                                                                                {{ old('en.return_policy',$product->translate('en')->return_policy)  }}
                                            </textarea>
                                    ...
                                    <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="de[name]"
                                                   class="form-control form-control-solid mb-3 mb-lg-0"
                                                   placeholder="{{ __('Product Name') }}" value="{{ old('de.name',$product->translate('de')->name) }}"/>
                                            @error('de.name')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea class="form-control form-control-solid mb-3 mb-lg-0" name="de[description]" id="description" cols="30" rows="10">
                                                {{old('de.description',$product->translate('de')->description)}}
                                            </textarea>
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea class="form-control form-control-solid mb-3 mb-lg-0" name="de[return_policy]" id="return_policy" cols="30" rows="10">
                                                                                                {{old('de.return_policy',$product->translate('de')->return_policy)}}
                                            </textarea>
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="slug"
                                       ...
                                       placeholder="the-post-slug-for-url" value="{{ old('slug',$product->slug) }}"/>
                                @error('slug')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="tags" class="form-control form-control-solid mb-3 mb-lg-0"
                                           placeholder="hygienic,treatment" value="{{ old('tags',$product->tags) }}"/>
                                    @error('tags')
                                    <div class="invalid-feedback d-block">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="fv-row mb-7">
                                <div class="col">
                                    @foreach($product->images ?? [] as $image)
                                        <img class="w-100px" src="{{ url('storage/' . $image) }}" alt="">
                                    @endforeach
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="mb-10">
                                    ...
                                    <div class="nav-group nav-group-fluid">
                                        <label>
                                            <input onchange="checkPriceInput()" {{ $product->price_status == 0? 'checked' : '' }}  type="radio" name="price_status" value="0" class="btn-check">
                                            <span class="btn btn-sm btn-color-muted btn-active btn-active-primary">Coming Soon</span>
                                        </label>
                                        <label>
                                            <input  onchange="checkPriceInput()" {{ $product->price_status == 1? 'checked' : '' }}  type="radio" name="price_status" value="1" class="btn-check">
                                            <span class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Normal</span>
                                        </label>
                                        <label>
                                            <input  onchange="checkPriceInput()"  {{ $product->price_status == 2? 'checked' : '' }} type="radio" name="price_status" value="2" class="btn-check">
                                            <span class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Call</span>
                                        </label>
                                        <label>
                                            <input  onchange="checkPriceInput()" {{ $product->price_status == 3? 'checked' : '' }}  type="radio" name="price_status" value="3" class="btn-check">
                            ...
                            <div class="fv-row mb-7" id="price_wrapper">
                                ...
                                <input type="text" name="price"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="180.00 USD" value="{{ old('price',$product->price) }}"/>
                                @error('price')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="fv-row mb-7">
                                <div class="row">
                                    <div class="mb-10">
                                        ...
                                        <div class="nav-group nav-group-fluid">
                                            <label class="">
                                                <input type="radio"  {{ $product->visibility == 1? 'checked' : '' }} name="visibility" value="1" class="btn-check">
                                                <span class="btn btn-sm btn-color-muted btn-active btn-active-primary">Visible</span>
                                            </label>

                                            <label>
                                                <input type="radio"  {{ $product->visibility == 0? 'checked' : '' }} name="visibility" value="0" class="btn-check">
