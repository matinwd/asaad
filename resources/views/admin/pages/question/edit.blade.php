...
@section('title','Questions / Create Question')
                                    ...
                                    <div class="tab-pane fade active show" id="kt_tab_pane_1" role="tabpanel">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="en[name]"
                                                   ...
                                                   placeholder="Question Name" value="{{ old('en.name',$question->translate('en')->name) }}"/>
                                            @error('en.name')
                                    ...
                                    <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="de[name]"
                                                   class="form-control form-control-solid mb-3 mb-lg-0"
                                                   placeholder="{{ __('Question Name') }}" value="{{ old('de.name',$question->translate('de')->name) }}"/>
                                            @error('de.name')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
