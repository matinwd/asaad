                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7">
                                    ...
                                    <div class="tab-pane fade active show" id="kt_tab_pane_1" role="tabpanel">
                                        <div class="fv-row">
                                            ...
                                            <input type="text" name="en[name]"
                                                   ...
                                                   placeholder="Slider Name" value="{{ old('en.name',$slider->translate('en')->name) }}"/>
                                            @error('en.name')
                                    ...
                                    <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
                                        <div class="fv-row">
                                            ...
                                            <input type="text" name="de[name]"
                                                   class="form-control form-control-solid mb-3 mb-lg-0"
                                                   placeholder="{{ __('Slider Name') }}" value="{{ old('de.name',$slider->translate('de')->name) }}"/>
                                            @error('de.name')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="fv-row mb-7">
                                @foreach($slider->images as $image)
                                    <img class="rounded w-100px mb-3" src="{{ url('storage/' . $image) }}" alt="">
                                @endforeach
                                    <br>
                            ...
                            <div class="fv-row">
                                ...
                                <input type="text" name="order"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="{{ __('Slider Position') }}" value="{{ old('order',$slider->order) }}"/>
                                @error('order')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
