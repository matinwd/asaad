...
@section('actions')
    <div class="d-flex align-items-center py-3 py-md-1">
        ...
        <div class="menu menu-sub menu-sub-dropdown w-450px w-md-500px" data-kt-menu="true">
            <div class="px-7 py-5">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="nav-group nav-group-fluid">
                            ...
                            @foreach (\App\Models\Ticket::$statusArray as $index => $item)
                                <label>
                                    <input type="radio" class="btn-check" name="status"
                                           value="{{ $index }}" {{ request('status','all') == $index ? 'checked' : '' }}/>
                                    <span
                                        class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">{{ $item }}</span>
                                </label>
                            @endforeach
                        </div>
                    </div>
        ...
        <div class="col-12">
            <div class="card card-flush min-h-300px">
                <div class="card-body py-4">
                    @includeIf('admin.pages.ticket.partials.table',$tickets)
                </div>
