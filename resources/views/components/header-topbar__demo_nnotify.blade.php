    ...
    <div class="topbar d-flex align-items-stretch flex-shrink-0">
                        ...
                        <div class="d-flex flex-column px-9">
                            ...
                            <div class="text-center px-4">
                                <img class="mw-100 mh-200px" alt="image"
                                     src="/assets/media/tmp-sigma-1-dark.png"/>
                            </div>
                            <!--end::Illustration-->
                        </div>
                        <!--end::Wrapper-->
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    ...
                    <a href="#"
                       ...
                       data-kt-menu-flip="bottom">
                        <i class="bi bi-sun fs-2x d-none"></i>
                    ...
                    <div
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3 my-1">
                            <a href="javascript:" class="menu-link px-3 active">
                                                            <span class="menu-icon">
        ...
        <div class="d-flex align-items-center me-n3 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            ...
            <div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px"
                 data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                 data-kt-menu-placement="bottom-end">
                <img class="h-30px w-30px rounded" src="{{ asset('temp/avatar-blank.png') }}" alt=""/>
            </div>
            <!--begin::Menu-->
            <div
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        <div class="symbol symbol-50px me-5">
                            <div
                                class="symbol-label fs-3 bg-light-{{ auth()->user()->avatar_color }} text-{{ auth()->user()->avatar_color }}">
                                {{ auth()->user()->avatar_character }}
                            </div>
                        </div>
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-5">
                    <a href="{{ route('billing') }}" class="menu-link px-5">
                        My Bills
                    </a>
                </div>
                <!--end::Menu item-->
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-5">
                    <a onclick="$('#frm-logout').submit()" href="javascript:"
