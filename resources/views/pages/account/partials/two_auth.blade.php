        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y pt-10 pb-15 px-lg-17">
                ...
                <div data-kt-element="options">
                    <!--begin::Notice-->
                    <p class="text-muted fs-5 fw-bold mb-10">In addition to your username and password, you’ll have
                ...
                <div class="d-none" data-kt-element="apps">
                    ...
                    <form data-kt-element="apps-form" class="form" action="#">
                        ...
                        <div class="d-flex flex-center">
                            <button type="reset" data-kt-element="apps-cancel" class="btn btn-light me-3">Cancel
                            </button>
                ...
                <div class="d-none" data-kt-element="sms">
                    ...
                    <!--end::Heading-->
                    <!--begin::Notice-->
                    <div class="text-muted fw-bold mb-10">Enter your mobile phone number with country code and we
                    ...
                    <form data-kt-element="sms-form" class="form" action="#">
                        ...
                        <!--begin::Actions-->
                        <div class="d-flex flex-center">
                            <button type="reset" data-kt-element="sms-cancel" class="btn btn-light me-3">Cancel
                            </button>
