                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 text-left">
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-4">
                                    ...
                                    @else
                                        <span
                                            class="symbol-label bg-{{ $signal->pair->logo_color }} text-inverse-{{ $signal->pair->logo_color }} fw-bolder">{{ $pair->logo_character }}</span>
                                    @endif
                                </div>
                        ...
                        <div class="col-md-4 text-left d-flex align-items-center">
                            ...
                            <div
                                class="text-gray-700 fw-bolder fs-6 ms-5">{{ $signal->candle_time->format('Y-m-d H:i:s') }}</div>
                        </div>
                    </div>
                    <div class="row mt-10">
                        <div class="col-md-4 text-left d-flex align-items-center">
        ...
        <div class="col-xl-12">
            <div class="card card-flush h-md-100 p-0">
                <div class="card-body p-0">
                    <iframe
                        src="http://chart.finomate.io/?signal_id={{ $signal->code }}&symbol={{ $signal->pair->symbol }}&timeframe={{ $signal->time_frame }}"
