...
@section('content')
    @includeIf('pages.account.partials.header',['activeMenu' => 1])
        ...
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8 d-flex align-items-center">
                    ...
                    <span class="badge badge-{{ auth()->user()->hasVerifiedEmail() ? 'success' : 'danger' }}">{{ auth()->user()->hasVerifiedEmail() ? 'Verified' : 'No Validation' }}</span> {{--Verified--}}
                </div>
            </div>
        </div>
    </div>
